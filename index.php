    ...
    <div class="page">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide bg-gray-lighter" data-slide-bg="images/slider-slide-1-1920x980.jpg">
              <div class="swiper-slide-caption text-center">
                <div class="container">
                  <h1 data-caption-animate="fadeInUpSmall"> <span>CRC SOFTWARE</span><sup class="text-accent"></sup></h1>
                    ...
                    <div class="vide_bg" data-vide-bg="video/video-lg" data-vide-options="posterType: jpg">
                      <div class="swiper-slide-caption text-center">
                        <div class="container">
                          ...
                          <div class="group-lg group-middle"><a class="button button-black" data-caption-animate="fadeInUpSmall" data-caption-delay="350" href="index.html#section-see-features" data-custom-scroll-to="section-see-features">See Features</a><a class="button button-primary" data-caption-animate="fadeInUpSmall" data-caption-delay="350" href="http://www.templatemonster.com/website-templates/monstroid2.html">Buy template</a></div>
                        </div>
                      </div>
                    </div>
            </div>
              ...
              <div class="pricing-table-wrap">
                <div class="pricing-table">
                  ...
                  <div class="pricing-header">
                    <h5>Software operacional</h5>
                  </div>
                  <div class="pricing-body">
                    <p>Si está buscando una compañía confiable y de buena reputación para construir su software operativo a medida, ha encontrado la compañía adecuada.
                      </p>
                  </div>
                  <div class="pricing-footer"><a class="button button-primary" href="home-business.html#">Buy now!</a></div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-xl-3">
            ...
            <div class="col-md-6 col-xl-3">
              <div class="pricing-table-wrap">
                <div class="pricing-table">
                  ...
                  <div class="pricing-header">
                    <h5>Aplicaciones web y móviles</h5>
                  </div>
                  <div class="pricing-body">
            ...
            <div class="col-md-6 col-xl-3">
              <div class="pricing-table-wrap">
                <div class="pricing-table">
                  ...
                  <div class="pricing-body">
                    <p>No solo creamos aplicaciones de software. Proporcionamos soporte y alojamiento, ayudando a que su sistema funcione y a que sus usuarios estén contentos todo el tiempo que nos necesite. Incluso asumiremos software que no hemos creado, lo solucionaremos, lo mantendremos y lo ayudaremos a llevar su proyecto al siguiente nivel.
        ...
        <div class="container">
          <div class="row row-50">
            <div class="col-md-12 col-lg-12">
                <h4>No solo creamos aplicaciones de software. Proporcionamos soporte y alojamiento, ayudando a que su sistema funcione y a que sus usuarios estén contentos todo el tiempo que nos necesite. Incluso asumiremos software que no hemos creado, lo solucionaremos, lo mantendremos y lo ayudaremos a llevar su proyecto al siguiente nivel.</h4>
              <!-- Blurb minimal-->
        ...
        <div class="container">
          <div class="row justify-content-md-center align-items-lg-end">
            <div class="col-md-8 col-lg-6 section-xl">
              ...
              <p>Cuando los teléfonos inteligentes comenzaron a despegar, muchas empresas se apresuraron a subirse al carro de la aplicación móvil. Cada negocio digno de su sal parecía ... </p><a class="button button-gray-light-outline" href="index.html#">View now!</a>
            </div>
      ...
      <section class="section-xl bg-default text-center">
        <div class="container">
          ...
          <!-- RD Mailform -->
          <form class="rd-mailform rd-mailform_style-1 rd-mailform_sizing-1 rd-mailform-inline-flex text-center" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="http://livedemo00.template-help.com/wt_62267_v4/62267-default/bat/rd-mailform.php">
        ...
        <div class="container">
          <div class="row justify-content-sm-center justify-content-lg-start row-30 row-md-60">
            ...
            <div class="col-sm-10 col-md-6 col-lg-3 col-xl-3">
              <h6>Navigation</h6>
              <ul class="list-xxs">
                <li><a href="index.html#">Retina Homepage</a></li>
                <li><a href="index.html#">New Page Examples</a></li>
                <li><a href="index.html#">Parallax Sections</a></li>
                <li><a href="index.html#">Shortcode Central</a></li>
                <li><a href="index.html#">Ultimate Font Collection</a></li>
              </ul>
            </div>
      ...
      <footer class="footer-corporate">
        <div class="container">
          <div class="footer-corporate__inner">
            <p class="rights"><span>Monstroid&#178;</span><span>&nbsp;</span><span id="copyright-year"></span>.
              <!-- {%FOOTER_LINK}-->
            </p>
            <ul class="list-inline-xxs">
              <li><a class="icon icon-xxs icon-primary fa fa-facebook" href="index.html#"></a></li>
              <li><a class="icon icon-xxs icon-primary fa fa-twitter" href="index.html#"></a></li>
              <li><a class="icon icon-xxs icon-primary fa fa-google-plus" href="index.html#"></a></li>
              <li><a class="icon icon-xxs icon-primary fa fa-vimeo" href="index.html#"></a></li>
              <li><a class="icon icon-xxs icon-primary fa fa-youtube" href="index.html#"></a></li>
              <li><a class="icon icon-xxs icon-primary fa fa-pinterest" href="index.html#"></a></li>
            </ul>
          </div>
        </div>
      </footer>
